...
pipeline = InferencePipeline.init(
    model_id="3d-shapes-aerrd/2", # set the model id to a yolov8x model with in put size 1280
    ...
    api_key='OhO9jbGN6ynyTtmLVVH8', # provide your roboflow api key for loading models from the roboflow api
)
# start the pipeline
pipeline.start()
